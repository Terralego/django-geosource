from django_geosource_nodes.celery.tasks import run_model_object_method
...
class CeleryCallMethodsMixin:
    ...
    def run_sync_method(self, method, success_state=states.SUCCESS):
        task_job = run_model_object_method.apply((self._meta.app_label, self.__class__.__name__, self.pk, method, success_state))
        self.update_status(task_job)
        return task_job
